...
`registry.codeocean.com/published/8085a343-60bb-438c-8941-2990060718bf:v3`
...
docker run --platform linux/amd64 --rm --gpus all \
  ...
  registry.codeocean.com/published/8085a343-60bb-438c-8941-2990060718bf:v3 bash run
```
